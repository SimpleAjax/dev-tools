...
export function DbBackupScheduler() {
    ...
    useEffect(() => {
        generateScript();
    }, [dbType, dbName, dbHost, dbUser, s3Bucket, s3Path, region, retentionDays]);
...
# 1. Dump Database
${dbType === 'postgres' ?
                `export PGPASSWORD="YOUR_PASSWORD_HERE" # Use .pgpass in production preferably
...
# Note: Use AWS S3 Lifecycle Policies for best practice retention
